      ...
      //  public string[] RoleNameArr=new string[] {"111","2222"};
        ...
        public override void OnBodyGUI()
        {
           ...
           // Debug.Log("操作chatnode中");
            ...
            {
              //  Debug.Log("重复渲染节点");
                NodeEditorGUILayout.DynamicPortList("chatslist", typeof(SingleChatClass), serializedObject, NodePort.IO.Output, Node.ConnectionType.Override, Node.TypeConstraint.None, DrawList);
            ...
            else
            {
                ...
                NodeEditorGUILayout.DynamicPortList("chatslist", typeof(SingleChatClass), serializedObject, NodePort.IO.Output, Node.ConnectionType.Override, Node.TypeConstraint.None, SimpleDrawList);
